...
async def add_auth_user(client: Client, message: Message):
    if message.chat.id != OWNER:
        await message.reply_text("**❌ Access Denied!** Only the bot owner can add authorized users.")
        return 
    try:
...
async def list_auth_users(client: Client, message: Message):
    if message.chat.id != OWNER:
        await message.reply_text("**❌ Access Denied!** Only the bot owner can view authorized users.")
        return
...
async def remove_auth_user(client: Client, message: Message):
    if message.chat.id != OWNER:
        await message.reply_text("**❌ Access Denied!** Only the bot owner can remove authorized users.")
        return
