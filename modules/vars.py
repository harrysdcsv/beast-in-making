...
TOTAL_USERS = [int(user_id.strip()) for user_id in TOTAL_USER if user_id.strip()]

AUTH_USER = os.environ.get('AUTH_USERS', '7385595817,7968237251').split(',')
AUTH_USERS = [int(user_id.strip()) for user_id in AUTH_USER if user_id.strip()]
